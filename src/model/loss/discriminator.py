...
class GANLoss(nn.Module):
    def __init__(self, disc_in_channels, disc_num_layers, disc_start, warm_up_end, pretrained=None, freeze=False, 
                 normalize=False, disc_loss='hinge', use_actnorm=False, use_adaptive_weight=True, weight=1.0, factor=1.0):
        super().__init__()
    ...
    def forward(self, inputs: torch.Tensor, reconstructions: torch.Tensor, global_step: int, update_g=False, last_layer=None, rec_loss=None):
        """
        ...
        if update_g:
            ...
            log = {"total_loss": g_loss.clone().detach().mean(),
...
class VQLPIPSWithDiscriminator(nn.Module):
    def __init__(self, disc_start, codebook_weight=1.0, pixelloss_weight=1.0,
        ...
        discriminator = NLayerDiscriminator(input_nc=disc_in_channels,
                                                 n_layers=disc_num_layers,
                                                 use_actnorm=use_actnorm,
                                                 ndf=disc_ndf
                                                 )
        discriminator = discriminator.apply(NLayerDiscriminator.weights_init)
